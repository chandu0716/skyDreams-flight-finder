    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Book the Skies and Chase Your Travel Dreams!</h1>
            <p className="banner-p">Fly beyond limits and book your dreams through extraordinary flight journeys that take you to unforgettable destinations — igniting a sense of adventure like never before.</p>     
          </div>
...
<option value="Kuala Lumpur">Kuala Lumpur</option>
        ...
        <div className="container">
            ...
            <span><h5>2025 SkyDreams - &copy; All rights reserved</h5></span>
